...
<section>
    <form name="actualizarPerfil" action="actualizarPerfil" method="POST" class="m-2" enctype="multipart/form-data" >
        {{ csrf_field() }} 
        <div class="row justify-content-center">
            <div class="col-sm-auto col-md-3 text-center">
                <h5>Editar Perfil</h5>
            </div>
        </div>
        <?php
        ...
        <div class="row justify-content-center mb-3">
            <div class="col-sm-auto col-md-5 text-center">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <div class="row justify-content-center mb-3">
                            <div class="col-sm-auto col-md-auto text-center">
                                <a class="nav-link"><img class="redes_perfil" src="<?php echo $rutaImagen; ?>" alt="login"></a>
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <fieldset>
                    ...
                    <!--                    <br>
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input type="text" id="dni" name="dni" class="form-control" placeholder="1234567X" value="<?php echo $valor["DNI"] ?>" required disabled>
                                        </div>-->
                    <br>
                    <div class="row justify-content-center mb-3">
                        <div class="col-sm-auto col-md-5 text-center">
                ...
                <div class="row justify-content-center mb-3">
                    <div class="col-sm-auto col-md-5 text-center">
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="date" id="nacimiento" name="nacimiento" class="form-control" required disabled value="<?php echo $valor["F_NACIMIENTO"] ?>">
                        </div>
                    </div>
                </div>
                <br>
